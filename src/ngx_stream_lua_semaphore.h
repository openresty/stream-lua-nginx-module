...
typedef struct ngx_stream_lua_semaphore_mm_block_s {
    ngx_uint_t                           used;
    ngx_stream_lua_semaphore_mm_t       *mm;
    ngx_uint_t                           epoch;
} ngx_stream_lua_semaphore_mm_block_t;


struct ngx_stream_lua_semaphore_mm_s {
...
typedef struct ngx_stream_lua_semaphore_s {
